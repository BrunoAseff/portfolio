  ...
  return (
    <main className="w-full left-0 bottom-0 absolute">
      <div className="relative left-0 bottom-0">
        <div className="absolute bg-[radial-gradient(circle_at_top_right,_transparent_40px,_#fff_30px)] rotate-6 h-[50px] w-[50px] -top-10 right-16"></div>
        ...
        <div className=" bg-white  mix-blend-screen  w-[500px] relative flex items-center justify-center text-center   rounded-tr-3xl  h-[80px]">
