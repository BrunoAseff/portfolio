      ...
      >
        ...
        {loading ? (
          ...
          <article className="z-50 max-w-[90%] md:max-w-[60%] ul:list-disc li:ml-6 ml-auto mr-auto items-center flex flex-col">
            ...
            <div
              className={`w-full [&>img]:rounded-xl [&>ul]:list-disc [&>ul]:ml-6 [&>h2]:mt-2 [&_p_a]:text-blue-500 [&_pre_code]:text-blue-100 [&>pre]:bg-slate-700 [&>pre]:rounded-md [&>pre]:p-4 [&>pre]:whitespace-pre-wrap [&>_p_code]:text-blue-500 [&>h1]:text-3xl [&>h1]:font-medium [&>h2]:text-xl [&>h2]:font-semibold  
